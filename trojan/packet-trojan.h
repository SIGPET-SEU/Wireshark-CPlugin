...
gint tvb_find_TLS_signature(tvbuff_t* tvb);
...
#define TROJAN_TLS_RANGE_PORT "49637,56306,52002,52203,52107,52108"
...
// static const gchar* trojan_keylog_file_name;
...
static char* TLS_signature[TLS_SIGNUM] = {
