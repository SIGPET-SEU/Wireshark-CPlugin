...
typedef struct _vmess_conv_t {
    ...
    gboolean req_frame_num;     /* Used to mark the VMess request frame number */
...
int dissect_decrypted_vmess_data(tvbuff_t* tvb, packet_info* pinfo, proto_tree* tree _U_, proto_tree* vmess_tree, vmess_message_info_t* msg, vmess_conv_t* conv_data);
